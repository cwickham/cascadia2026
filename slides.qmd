...
* During Your Turns ([]{.postit .pink} Pink Post-it: Send help!)
* After Your Turns
* In Slack channel
...
3. Open and preview `index.qmd`. (Put up []{.postit .orange} orange Post-it)
...
```{.default code-line-numbers="1-3|1-4|5-6|7-8|9"}
website/
├── _quarto.yml   
├── index.qmd      
...
|    └── feb.qmd      { base url }/reports/feb.html 
└── data/             
...
1.  Make your project a Git repo. Add `_site/` to `.gitignore`
...
![](https://quarto-tdg.org/images/website-listing-default.png){height="400px"}

## People

![](https://quarto-tdg.org/images/website-listing-grid.png){height="400px"}

## Publications

![](https://quarto-tdg.org/images/website-listing-table.png){height="400px"}
...
``` {.yaml filename="_examples/listing-talks/talks.yml" code-line-numbers="|1-5|5"}
- date: 2025-03-12
...
````{.markdown .code-overflow-wrap filename="projects/coastal-sensors.qmd" code-line-numbers="|1-6"}
---
...
1. Drag the content of one of `_examples/listing-projects/` or `_examples/listing-talks/` into your website.
